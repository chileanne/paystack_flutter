...
class PaymentCard {
  ...
  PaymentCard({required String? number, required String? cvc, required this.expiryMonth, required this.expiryYear, String? name, String? addressLine1, String? addressLine2, String? addressLine3, String? addressLine4, String? addressPostCode, String? addressCountry, String? country}) {
    this.number = number;
    this.cvc = cvc;
  ...
  bool isValid() {
    return cvc != null && number != null && expiryMonth != null && expiryYear != null && validNumber(null) && CardUtils.isNotExpired(expiryYear, expiryMonth) && validCVC(null);
  }
  ...
  bool validCVC(String? cardCvc) {
    ...
    bool validLength = ((_type == null && cvcValue.length >= 3 && cvcValue.length <= 4) || (CardType.americanExpress == _type && cvcValue.length == 4) || (CardType.americanExpress != _type && cvcValue.length == 3));
