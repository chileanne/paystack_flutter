  ...
  Widget buildChild(BuildContext context) {
    return new CustomAlertDialog(
      ...
      child: Container(
        ...
        child: new Column(
          children: <Widget>[
            new Image.asset('assets/images/dob.png', width: 30.0, package: 'paystack_flutter'),
            _heightBox,
            new Text(
              widget.message,
            ...
            _pickedDate == null
                ...
                : new WhiteButton(
                    ...
                    child: new Row(
                      ...
                      children: <Widget>[new Flexible(flex: 4, child: dateItem(_getMonth())), new Flexible(flex: 2, child: dateItem(_getDay())), new Flexible(flex: 3, child: dateItem(_getYear()))],
                    ),
                  ),
            new SizedBox(
